...
5. **Model auto-resolver** — `model: "auto"` resolves to the less-hallucinating model for the active provider (`gpt-5-mini`, `claude-sonnet-4.6`, or `gemini-2.5-flash` per Vectara HHEM 2026-05-11), not whatever the provider's "auto" picks.
