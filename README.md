...
[![GitHub release](https://img.shields.io/github/v/release/JosiahSiegel/umactually)](https://github.com/JosiahSiegel/umactually/releases/tag/v0.3.0)
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)
[![Node.js >=24](https://img.shields.io/badge/node-%3E%3D24-339933.svg)](https://nodejs.org/)

Latest release: **[v0.3.0](https://github.com/JosiahSiegel/umactually/releases/tag/v0.3.0)** — see [all releases](https://github.com/JosiahSiegel/umactually/releases).
...
```bash
npx github:JosiahSiegel/umactually#v0.3.0 review
```

The `#v0.3.0` fragment pins the install to the [v0.3.0 release tag](https://github.com/JosiahSiegel/umactually/releases/tag/v0.3.0). Omit the fragment only when you specifically want the latest unreleased `main` build. The `umactually` npm package is not yet published — `npm install -g umactually` will 404 until a future release.
...
CI must use Node.js 24 and a version-pinned install. Pin to the [`v0.3.0` release tag](https://github.com/JosiahSiegel/umactually/releases/tag/v0.3.0) — never track `main` and never use the interactive binary installers in a CI step.
  ...
  review:
    ...
    steps:
      ...
      - name: Run umactually PR review
        ...
        # Pin to the v0.3.0 release tag — `npx github:owner/repo#tag` resolves
...
steps:
  ...
  # to the GitHub tarball at that ref, so the install is reproducible
  # instead of tracking `main`. The npm package is not yet published.
  - script: npx github:JosiahSiegel/umactually#v0.3.0 review --platform azure-devops
