...
[![GitHub release](https://img.shields.io/github/v/release/JosiahSiegel/umactually)](https://github.com/JosiahSiegel/umactually/releases/tag/v0.6.7)
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)
[![Node.js >=24](https://img.shields.io/badge/node-%3E%3D24-339933.svg)](https://nodejs.org/)

Latest release: **[v0.6.7](https://github.com/JosiahSiegel/umactually/releases/tag/v0.6.7)** — see [all releases](https://github.com/JosiahSiegel/umactually/releases).
...
curl -fsSL https://github.com/JosiahSiegel/umactually/raw/main/scripts/install.sh | sh -s -- --tag v0.6.7
```
...
```bash
npx github:JosiahSiegel/umactually#v0.6.7 review
```

The `#v0.6.7` fragment pins to the tagged release. Omit it only when you specifically want the latest unreleased `main` build.
...
CI must use Node.js 24 and a version-pinned install. Pin to the [`v0.6.7` release tag](https://github.com/JosiahSiegel/umactually/releases/tag/v0.6.7) — never track `main` and never use the interactive binary installers in a CI step.
