...
[![GitHub release](https://img.shields.io/github/v/release/JosiahSiegel/umactually)](https://github.com/JosiahSiegel/umactually/releases/tag/v0.6.18)
...
Latest release: **[v0.6.18](https://github.com/JosiahSiegel/umactually/releases/tag/v0.6.18)** — see [all releases](https://github.com/JosiahSiegel/umactually/releases).
...
curl -fsSL https://github.com/JosiahSiegel/umactually/raw/main/scripts/install.sh | sh -s -- --tag v0.6.18
```
...
```bash
npx github:JosiahSiegel/umactually#v0.6.18 review
```

The `#v0.6.18` fragment pins to the tagged release. Omit it only when you specifically want the latest unreleased `main` build.
...
CI must use Node.js 24 and a version-pinned install. Pin to the [`v0.6.18` release tag](https://github.com/JosiahSiegel/umactually/releases/tag/v0.6.18) — never track `main` and never use the interactive binary installers in a CI step.
