...
[![GitHub release](https://img.shields.io/github/v/release/JosiahSiegel/umactually)](https://github.com/JosiahSiegel/umactually/releases/tag/v0.5.5)
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)
[![Node.js >=24](https://img.shields.io/badge/node-%3E%3D24-339933.svg)](https://nodejs.org/)

Latest release: **[v0.5.5](https://github.com/JosiahSiegel/umactually/releases/tag/v0.5.5)** — see [all releases](https://github.com/JosiahSiegel/umactually/releases).
...
curl -fsSL https://github.com/JosiahSiegel/umactually/raw/main/scripts/install.sh | sh -s -- --tag v0.5.5
...
```bash
npx github:JosiahSiegel/umactually#v0.5.5 review
```

The `#v0.5.5` fragment pins the install to the tagged release. Omit the fragment only when you specifically want the latest unreleased `main` build. The `umactually` npm package is not yet published — `npm install -g umactually` will 404 until a future release.
...
CI must use Node.js 24 and a version-pinned install. Pin to the [`v0.5.5` release tag](https://github.com/JosiahSiegel/umactually/releases/tag/v0.5.5) — never track `main` and never use the interactive binary installers in a CI step.
