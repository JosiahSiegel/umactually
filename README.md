...
[![GitHub release](https://img.shields.io/github/v/release/JosiahSiegel/umactually)](https://github.com/JosiahSiegel/umactually/releases/tag/v0.6.21)
...
curl -fsSL https://github.com/JosiahSiegel/umactually/raw/main/scripts/install.sh | sh -s -- --tag v0.6.21
```
...
```bash
npx github:JosiahSiegel/umactually#v0.6.21 review
```

The `#v0.6.21` fragment pins to the tagged release. Omit it only when you specifically want the latest unreleased `main` build.
...
CI must use Node.js 24 and a version-pinned install. Pin to the [`v0.6.21` release tag](https://github.com/JosiahSiegel/umactually/releases/tag/v0.6.21) — never track `main` and never use the interactive binary installers in a CI step.
