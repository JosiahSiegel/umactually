...
[![GitHub release](https://img.shields.io/github/v/release/JosiahSiegel/umactually)](https://github.com/JosiahSiegel/umactually/releases/tag/v0.10.1)
...
Latest release: **[v0.10.1](https://github.com/JosiahSiegel/umactually/releases/tag/v0.10.1)** — see [all releases](https://github.com/JosiahSiegel/umactually/releases).
## Quickstart
...
CI must use Node.js 24 and a version-pinned install. Pin to [`v0.10.1`](https://github.com/JosiahSiegel/umactually/releases/tag/v0.10.1) — never track `main`.
