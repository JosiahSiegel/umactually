...
[![GitHub release](https://img.shields.io/github/v/release/JosiahSiegel/umactually)](https://github.com/JosiahSiegel/umactually/releases/tag/v0.9.4)
...
Latest release: **[v0.9.4](https://github.com/JosiahSiegel/umactually/releases/tag/v0.9.4)** — see [all releases](https://github.com/JosiahSiegel/umactually/releases).
## Quickstart
...
CI must use Node.js 24 and a version-pinned install. Pin to [`v0.9.4`](https://github.com/JosiahSiegel/umactually/releases/tag/v0.9.4) — never track `main`.
