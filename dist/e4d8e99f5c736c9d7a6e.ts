...
import { CliHelpSignal, CliUsageError, parseCliArgs } from "./cli/parse-args.js";
...
import { dispatchLive, runDryRun } from "./cli/run.js";
import { runLocalFilesReview } from "./cli/local-files-run.js";
...
export function readPackageVersion() {
    ...
    const packageJsonUrl = __webpack_require__.ab + "package.json";
 ...
 */
export function isVersionFlag(argv) {
 ...
 */
export function runVersion(_argv) {
...
export function buildSanitizedResolvedConfig(resolved, reviewPolicy = {
    path: null,
    hash: null,
    schemaVersion: null,
}) {
